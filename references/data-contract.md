...
```bash
python3 scripts/wm_crm.py init --db .wm/wm.db --project-name "Solar NG" --product "solar street lights" --countries "Nigeria"
python3 scripts/wm_crm.py set-project --db .wm/wm.db --json-file project.json
python3 scripts/wm_crm.py upsert-company --db .wm/wm.db --json-file company.json
python3 scripts/wm_crm.py upsert-contact --db .wm/wm.db --json-file contact.json
python3 scripts/wm_crm.py upsert-competitor --db .wm/wm.db --json-file competitor.json
python3 scripts/wm_crm.py upsert-social --db .wm/wm.db --json-file social.json
python3 scripts/wm_crm.py upsert-outreach --db .wm/wm.db --json-file outreach.json
python3 scripts/wm_crm.py upsert-activation --db .wm/wm.db --json-file activation.json
python3 scripts/wm_crm.py activation-report --db .wm/wm.db --as-of 2026-09-10
python3 scripts/wm_crm.py upsert-campaign --db .wm/wm.db --json-file campaign.json
python3 scripts/wm_crm.py add-evidence --db .wm/wm.db --json-file evidence.json
python3 scripts/wm_crm.py status --db .wm/wm.db
python3 scripts/wm_crm.py validate --db .wm/wm.db
python3 scripts/wm_crm.py export --db .wm/wm.db --out-dir .wm/export
```
